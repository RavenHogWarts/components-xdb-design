...
所有公开 DOM 扩展点回调（Action editor / view / settings / Field Renderer / Field Settings / cover）的 `props` 都带这组公共上下文：
...
- `MarkdownRenderer`：旧入口；改用 `props.obsidian.MarkdownRenderer`。
